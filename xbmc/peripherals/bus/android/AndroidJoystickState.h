...
namespace PERIPHERALS
{
  ...
  public:
     ...
     */
    void GetEvents(std::vector<kodi::addon::peripheral::PeripheralEvent>& events) const;
  ...
  private:
    ...
    void GetButtonEvents(std::vector<kodi::addon::peripheral::PeripheralEvent>& events) const;
    void GetHatEvents(std::vector<kodi::addon::peripheral::PeripheralEvent>& events) const;
    void GetAxisEvents(std::vector<kodi::addon::peripheral::PeripheralEvent>& events) const;
