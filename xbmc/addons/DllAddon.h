...
public:
  ...
  virtual ADDON_STATUS CreateInstance(int instanceType, const char* instanceID, KODI_HANDLE instance, KODI_HANDLE* addonInstance, ::kodi::addon::IAddonInstance* parent) =0;
...
public:
  ...
  DEFINE_METHOD5(ADDON_STATUS, CreateInstance, (int p1, const char* p2, KODI_HANDLE p3, KODI_HANDLE* p4, ::kodi::addon::IAddonInstance* p5))
