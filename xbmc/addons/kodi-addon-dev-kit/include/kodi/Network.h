...
extern "C"
{
  ...
  typedef struct sAddonToKodiFuncTable_kodi_network
  {
    bool (*wake_on_lan)(void* kodiInstance, const char *mac);
    char* (*get_ip_address)(void* kodiInstance);
...
namespace network
{
  ...
  {
    return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_network->wake_on_lan(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, mac.c_str());
  }
  //----------------------------------------------------------------------------
  ...
  {
    std::string ip;
    char* string = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_network->get_ip_address(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance);
    if (string != nullptr)
    {
      ip = string;
      ::kodi::addon::CAddonBase::m_instance->toKodi.free_string(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, string);
    }
    return ip;
  }
  //----------------------------------------------------------------------------
  ...
  inline std::string URLEncode(const std::string& url)
  {
    ...
    char* string = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_network->url_encode(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, url.c_str());
    if (string != nullptr)
    {
      retString = string;
      ::kodi::addon::CAddonBase::m_instance->toKodi.free_string(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, string);
  ...
  {
    bool ret = false;
    char* ipAddress = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_network->dns_lookup(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, strHostName.c_str(), &ret);
    if (ipAddress != nullptr)
    {
      strIpAddress = ipAddress;
      ::kodi::addon::CAddonBase::m_instance->toKodi.free_string(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, ipAddress);
    }
    return ret;
  }
  //----------------------------------------------------------------------------
