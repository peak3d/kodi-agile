...
namespace adsp {
  ...
  public:
      ...
      : m_instance(static_cast<sFuncTable_AudioDSP*>(instance))
    {
      ...
      m_instance->toAddon.GetDSPName = ADDON_GetDSPName;
      m_instance->toAddon.GetDSPVersion = ADDON_GetDSPVersion;
      m_instance->toAddon.MenuHook = ADDON_MenuHook;

      m_instance->toAddon.StreamCreate = ADDON_StreamCreate;
      m_instance->toAddon.StreamDestroy = ADDON_StreamDestroy;
      m_instance->toAddon.StreamIsModeSupported = ADDON_StreamIsModeSupported;
      m_instance->toAddon.StreamInitialize = ADDON_StreamInitialize;

      m_instance->toAddon.InputProcess = ADDON_InputProcess;

      m_instance->toAddon.InputResampleProcessNeededSamplesize = ADDON_InputResampleProcessNeededSamplesize;
      m_instance->toAddon.InputResampleProcess = ADDON_InputResampleProcess;
      m_instance->toAddon.InputResampleGetDelay = ADDON_InputResampleGetDelay;
      m_instance->toAddon.InputResampleSampleRate = ADDON_InputResampleSampleRate;

      m_instance->toAddon.PreProcessNeededSamplesize = ADDON_PreProcessNeededSamplesize;
      m_instance->toAddon.PreProcessGetDelay = ADDON_PreProcessGetDelay;
      m_instance->toAddon.PreProcess = ADDON_PreProcess;

      m_instance->toAddon.MasterProcessSetMode = ADDON_MasterProcessSetMode;
      m_instance->toAddon.MasterProcessNeededSamplesize = ADDON_MasterProcessNeededSamplesize;
      m_instance->toAddon.MasterProcessGetDelay = ADDON_MasterProcessGetDelay;
      m_instance->toAddon.MasterProcessGetOutChannels = ADDON_MasterProcessGetOutChannels;
      m_instance->toAddon.MasterProcess = ADDON_MasterProcess;
      m_instance->toAddon.MasterProcessGetStreamInfoString = ADDON_MasterProcessGetStreamInfoString;

      m_instance->toAddon.PostProcessNeededSamplesize = ADDON_PostProcessNeededSamplesize;
      m_instance->toAddon.PostProcessGetDelay = ADDON_PostProcessGetDelay;
      m_instance->toAddon.PostProcess = ADDON_PostProcess;

      m_instance->toAddon.OutputResampleProcessNeededSamplesize = ADDON_OutputResampleProcessNeededSamplesize;
      m_instance->toAddon.OutputResampleProcess = ADDON_OutputResampleProcess;
      m_instance->toAddon.OutputResampleGetDelay = ADDON_OutputResampleGetDelay;
      m_instance->toAddon.OutputResampleSampleRate = ADDON_OutputResampleSampleRate;
    }
    //--------------------------------------------------------------------------
    ...
    /// GetCapabilities
    ///
    virtual unsigned int InputResampleProcess(const ADDON_HANDLE handle, float **array_in, float **array_out, unsigned int samples) { return 0; }
    //--------------------------------------------------------------------------
    ...
    */
    ...
    /// GetCapabilities
    ///
    virtual unsigned int PreProcess(const ADDON_HANDLE handle, unsigned int mode_id, float **array_in, float **array_out, unsigned int samples) { return 0; }
    //--------------------------------------------------------------------------
    //@}
    ...
    */
    ...
    /// GetCapabilities
    ///
    virtual unsigned int MasterProcess(const ADDON_HANDLE handle, float **array_in, float **array_out, unsigned int samples) { return 0; }
    //--------------------------------------------------------------------------
    ...
    */
    ...
    /// GetCapabilities
    ///
    virtual unsigned int PostProcess(const ADDON_HANDLE handle, unsigned int mode_id, float **array_in, float **array_out, unsigned int samples) { return 0; }
    ...
    */
    ...
    /// GetCapabilities
    ///
    virtual unsigned int OutputResampleProcess(const ADDON_HANDLE handle, float **array_in, float **array_out, unsigned int samples) { return 0; }
    //--------------------------------------------------------------------------
  ...
  private:
    static inline void ADDON_GetCapabilities(void* addonInstance, AE_DSP_ADDON_CAPABILITIES *capabilities)
    {
      static_cast<CAddon*>(addonInstance)->GetCapabilities(*capabilities);
    }

    static inline const char* ADDON_GetDSPName(void* addonInstance)
    {
      CAddon* me = static_cast<CAddon*>(addonInstance);
      me->m_dspName = me->GetDSPName();
      return me->m_dspName.c_str();
    }

    static inline const char* ADDON_GetDSPVersion(void* addonInstance)
    {
      CAddon* me = static_cast<CAddon*>(addonInstance);
      me->m_dspVersion = me->GetDSPVersion();
      return me->m_dspVersion.c_str();
    }

    static inline AE_DSP_ERROR ADDON_MenuHook(void* addonInstance, const AE_DSP_MENUHOOK& menuhook, const AE_DSP_MENUHOOK_DATA &item)
    {
      return static_cast<CAddon*>(addonInstance)->MenuHook(menuhook, item);
    }

    static inline AE_DSP_ERROR ADDON_StreamCreate(void* addonInstance, const AE_DSP_SETTINGS *addonSettings, const AE_DSP_STREAM_PROPERTIES* properties, ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->StreamCreate(*addonSettings, *properties, handle);
    }

    static inline AE_DSP_ERROR ADDON_StreamDestroy(void* addonInstance, const ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->StreamDestroy(handle);
    }

    static inline AE_DSP_ERROR ADDON_StreamIsModeSupported(void* addonInstance, const ADDON_HANDLE handle, AE_DSP_MODE_TYPE type, unsigned int mode_id, int unique_db_mode_id)
    {
      return static_cast<CAddon*>(addonInstance)->StreamIsModeSupported(handle, type, mode_id, unique_db_mode_id);
    }

    static inline AE_DSP_ERROR ADDON_StreamInitialize(void* addonInstance, const ADDON_HANDLE handle, const AE_DSP_SETTINGS *addonSettings)
    {
      return static_cast<CAddon*>(addonInstance)->StreamInitialize(handle, *addonSettings);
    }

    static inline bool ADDON_InputProcess(void* addonInstance, const ADDON_HANDLE handle, const float **array_in, unsigned int samples)
    {
      return static_cast<CAddon*>(addonInstance)->InputProcess(handle, array_in, samples);
    }

    static inline unsigned int ADDON_InputResampleProcessNeededSamplesize(void* addonInstance, const ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->InputResampleProcessNeededSamplesize(handle);
    }

    static inline unsigned int ADDON_InputResampleProcess(void* addonInstance, const ADDON_HANDLE handle, float **array_in, float **array_out, unsigned int samples)
    {
      return static_cast<CAddon*>(addonInstance)->InputResampleProcess(handle, array_in, array_out, samples);
    }

    static inline int ADDON_InputResampleSampleRate(void* addonInstance, const ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->InputResampleSampleRate(handle);
    }

    static inline float ADDON_InputResampleGetDelay(void* addonInstance, const ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->InputResampleGetDelay(handle);
    }

    static inline unsigned int ADDON_PreProcessNeededSamplesize(void* addonInstance, const ADDON_HANDLE handle, unsigned int mode_id)
    {
      return static_cast<CAddon*>(addonInstance)->PreProcessNeededSamplesize(handle, mode_id);
    }

    static inline float ADDON_PreProcessGetDelay(void* addonInstance, const ADDON_HANDLE handle, unsigned int mode_id)
    {
      return static_cast<CAddon*>(addonInstance)->PreProcessGetDelay(handle, mode_id);
    }

    static inline unsigned int ADDON_PreProcess(void* addonInstance, const ADDON_HANDLE handle, unsigned int mode_id, float **array_in, float **array_out, unsigned int samples)
    {
      return static_cast<CAddon*>(addonInstance)->PreProcess(handle, mode_id, array_in, array_out, samples);
    }

    static inline AE_DSP_ERROR ADDON_MasterProcessSetMode(void* addonInstance, const ADDON_HANDLE handle, AE_DSP_STREAMTYPE type, unsigned int mode_id, int unique_db_mode_id)
    {
      return static_cast<CAddon*>(addonInstance)->MasterProcessSetMode(handle, type, mode_id, unique_db_mode_id);
    }

    static inline unsigned int ADDON_MasterProcessNeededSamplesize(void* addonInstance, const ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->MasterProcessNeededSamplesize(handle);
    }

    static inline float ADDON_MasterProcessGetDelay(void* addonInstance, const ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->MasterProcessGetDelay(handle);
    }

    static inline int ADDON_MasterProcessGetOutChannels(void* addonInstance, const ADDON_HANDLE handle, unsigned long &out_channel_present_flags)
    {
      return static_cast<CAddon*>(addonInstance)->MasterProcessGetOutChannels(handle, out_channel_present_flags);
    }

    static inline unsigned int ADDON_MasterProcess(void* addonInstance, const ADDON_HANDLE handle, float **array_in, float **array_out, unsigned int samples)
    {
      return static_cast<CAddon*>(addonInstance)->MasterProcess(handle, array_in, array_out, samples);
    }

    static inline const char* ADDON_MasterProcessGetStreamInfoString(void* addonInstance, const ADDON_HANDLE handle)
    {
      CAddon* me = static_cast<CAddon*>(addonInstance);
      me->m_streamInfoString = me->MasterProcessGetStreamInfoString(handle);
      return me->m_streamInfoString.c_str();
    }

    static inline unsigned int ADDON_PostProcessNeededSamplesize(void* addonInstance, const ADDON_HANDLE handle, unsigned int mode_id)
    {
      return static_cast<CAddon*>(addonInstance)->PostProcessNeededSamplesize(handle, mode_id);
    }

    static inline float ADDON_PostProcessGetDelay(void* addonInstance, const ADDON_HANDLE handle, unsigned int mode_id)
    {
      return static_cast<CAddon*>(addonInstance)->PostProcessGetDelay(handle, mode_id);
    }

    static inline unsigned int ADDON_PostProcess(void* addonInstance, const ADDON_HANDLE handle, unsigned int mode_id, float **array_in, float **array_out, unsigned int samples)
    {
      return static_cast<CAddon*>(addonInstance)->PostProcess(handle, mode_id, array_in, array_out, samples);
    }

    static inline unsigned int ADDON_OutputResampleProcessNeededSamplesize(void* addonInstance, const ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->OutputResampleProcessNeededSamplesize(handle);
    }

    static inline unsigned int ADDON_OutputResampleProcess(void* addonInstance, const ADDON_HANDLE handle, float **array_in, float **array_out, unsigned int samples)
    {
      return static_cast<CAddon*>(addonInstance)->OutputResampleProcess(handle, array_in, array_out, samples);
    }

    static inline int ADDON_OutputResampleSampleRate(void* addonInstance, const ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->OutputResampleSampleRate(handle);
    }

    static inline float ADDON_OutputResampleGetDelay(void* addonInstance, const ADDON_HANDLE handle)
    {
      return static_cast<CAddon*>(addonInstance)->OutputResampleGetDelay(handle);
    }
