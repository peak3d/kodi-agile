...
namespace gui
{
  ...
  namespace DialogFileBrowser
  {
      ...
      bool                    writeOnly = false)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogFileBrowser.ShowAndGetDirectory(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, shares.c_str(), heading.c_str(), path[0], size, writeOnly);
      path.resize(size);
      path.shrink_to_fit();
      return ret;
    }
      ...
      bool                    useFileDirectories = false)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogFileBrowser.ShowAndGetFile(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, shares.c_str(), mask.c_str(), heading.c_str(), file[0], size, useThumbs, useFileDirectories);
      file.resize(size);
      file.shrink_to_fit();
      return ret;
    }
      ...
      bool                    singleList = false)
    {
      path.resize(1024);
      unsigned int size = (unsigned int)path.capacity();
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogFileBrowser.ShowAndGetFileFromDir(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, directory.c_str(), mask.c_str(), heading.c_str(), path[0], size, useThumbs, useFileDirectories, singleList);
      path.resize(size);
      path.shrink_to_fit();
      return ret;
    }
      ...
      bool                    useFileDirectories = false)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogFileBrowser.ShowAndGetFileList(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, shares.c_str(), mask.c_str(), heading.c_str(), list, listSize, useThumbs, useFileDirectories);
      if (ret)
      {
        for (unsigned int i = 0; i < listSize; ++i)
          path.push_back(list[i]);
        ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogFileBrowser.ClearList(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, list, listSize);
      }
      return ret;
    }
    //--------------------------------------------------------------------------
      ...
      const std::string&      type = "")
    {
      path.resize(1024);
      unsigned int size = (unsigned int)path.capacity();
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogFileBrowser.ShowAndGetSource(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, path[0], size, allowNetworkShares, additionalShare.c_str(), type.c_str());
      path.resize(size);
      path.shrink_to_fit();
      return ret;
    }
      ...
      std::string&            path)
    {
      path.resize(1024);
      unsigned int size = (unsigned int)path.capacity();
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogFileBrowser.ShowAndGetImage(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, shares.c_str(), heading.c_str(), path[0], size);
      path.resize(size);
      path.shrink_to_fit();
      return ret;
    }
      ...
      std::vector<std::string> &path)
    {
      char** list;
      unsigned int listSize = 0;
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogFileBrowser.ShowAndGetImageList(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, shares.c_str(), heading.c_str(), list, listSize);
      if (ret)
      {
        for (unsigned int i = 0; i < listSize; ++i)
          path.push_back(list[i]);
