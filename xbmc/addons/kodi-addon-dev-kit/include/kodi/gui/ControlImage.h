...
namespace gui
{
  ...
  public:
    ...
    {
      m_ControlHandle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetControl_Image(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_Window->m_WindowHandle, controlId);
      if (!m_ControlHandle)
        kodi::Log(LOG_FATAL, "kodi::gui::CControlImage can't create control class from Kodi !!!");
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlImage.SetVisible(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, visible);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlImage.SetFileName(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, strFileName.c_str(), useCache);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlImage.SetColorDiffuse(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, colorDiffuse);
    }
    //--------------------------------------------------------------------------
