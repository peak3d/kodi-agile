...
namespace gui
{
  ...
  namespace DialogSelect
  {
      ...
      bool autoclose = false)
    {
      ...
      int ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogSelect.Open(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, heading.c_str(), cEntries, size, selected, autoclose);
      free(cEntries);
      return ret;
    }
    //--------------------------------------------------------------------------
