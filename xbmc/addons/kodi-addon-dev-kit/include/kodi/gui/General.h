...
namespace gui
{
  ...
  inline void Lock()
  {
    ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->general.Lock();
  }
  ...
  inline void Unlock()
  {
    ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->general.Unlock();
  }
  //--------------------------------------------------------------------------
  ...
  {
    return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->general.GetScreenHeight(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance);
  }
  //--------------------------------------------------------------------------
  ...
  {
    return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->general.GetScreenWidth(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance);
  }
  //--------------------------------------------------------------------------
  ...
  {
    return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->general.GetVideoResolution(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance);
  }
  //--------------------------------------------------------------------------
  ...
  {
    return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->general.GetCurrentWindowDialogId(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance);
  }
  //--------------------------------------------------------------------------
  ...
  {
    return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->general.GetCurrentWindowId(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance);
  }
  //--------------------------------------------------------------------------
