...
namespace gui
{
  ...
  namespace DialogContextMenu
  {
      ...
      const std::vector<std::string>& entries)
    {
      ...
      int ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogContextMenu.Open(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, heading.c_str(), cEntries, size);
      free(cEntries);
      return ret;
    }
    //--------------------------------------------------------------------------
