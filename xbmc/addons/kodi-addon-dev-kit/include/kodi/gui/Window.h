...
namespace gui
{
  ...
  public:
    ...
    {
      m_WindowHandle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.New(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, xmlFilename.c_str(),
                            defaultSkin.c_str(), forceFallback, asDialog);
      if (!m_WindowHandle)
        kodi::Log(LOG_FATAL, "kodi::gui::CControlButton can't create window class from Kodi !!!");

      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.SetCallbacks(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, this,
    ...
    {
      if (m_WindowHandle)
        ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.Delete(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    bool Show()
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.Show(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    void Close()
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.Close(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    void DoModal()
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.DoModal(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.SetFocusId(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, iControlId);
    }
    //--------------------------------------------------------------------------
    ...
    int GetFocusId()
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetFocusId(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.SetControlLabel(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, controlId, label.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.SetProperty(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, key.c_str(), value.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    std::string GetProperty(const std::string& key) const
    {
      ...
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetProperty(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, key.c_str(), label[0], size);
      label.resize(size);
      label.shrink_to_fit();
      return label.c_str();
    }
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.SetPropertyInt(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, key.c_str(), value);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetPropertyInt(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, key.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.SetPropertyBool(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, key.c_str(), value);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetPropertyBool(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, key.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.SetPropertyDouble(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, key.c_str(), value);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetPropertyDouble(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, key.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.ClearProperties(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.ClearProperty(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, key.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    {
      GUIHANDLE handle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.AddStringItem(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, name.c_str(), itemPosition);
      if (handle)
        return new CListItem(handle);

      kodi::Log(LOG_FATAL, "cGUIWindow Failed to get control on list ṕosition %i !!!", itemPosition);
      return nullptr;
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.AddItem(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, item->m_ListItemHandle, itemPosition);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.RemoveItem(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, itemPosition);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.RemoveItemFile(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, item->m_ListItemHandle);
    }
    //--------------------------------------------------------------------------
    ...
    {
      GUIHANDLE handle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetListItem(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, listPos);
      if (handle)
        return new CListItem(handle);

      kodi::Log(LOG_FATAL, "cGUIWindow Failed to get control on list ṕosition %i !!!", listPos);
      return nullptr;
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.SetCurrentListPosition(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, listPos);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetCurrentListPosition(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    int GetListSize()
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetListSize(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    void ClearList()
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.ClearList(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.MarkDirtyRegion(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle);
    }
    //--------------------------------------------------------------------------
    ...
    )
    {
      ...
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.SetCallbacks(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_WindowHandle, cbhdl,
                                CBOnInit, CBOnFocus, CBOnClick, CBOnAction);
    }
    //--------------------------------------------------------------------------
    /// @}
