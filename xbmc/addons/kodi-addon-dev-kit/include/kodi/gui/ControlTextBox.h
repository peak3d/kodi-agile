...
namespace gui
{
  ...
  public:
    ...
    {
      m_ControlHandle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetControl_TextBox(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_Window->m_WindowHandle, controlId);
      if (!m_ControlHandle)
        kodi::Log(LOG_FATAL, "kodi::gui::CControlTextBox can't create control class from Kodi !!!");
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlTextBox.SetVisible(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle,  visible);
    }
    //--------------------------------------------------------------------------
    ...
    void Reset()
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlTextBox.Reset(m_ControlHandle, m_ControlHandle);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlTextBox.SetText(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle,  text.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    std::string GetText() const
    {
      ...
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlTextBox.GetText(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, text[0], size);
      text.resize(size);
      text.shrink_to_fit();
      return text;
    }
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlTextBox.Scroll(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, position);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlTextBox.SetAutoScrolling(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, delay, time, repeat);
    }
    //--------------------------------------------------------------------------
