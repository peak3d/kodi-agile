...
namespace gui
{
  ...
  public:
    ...
    {
      m_ControlHandle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetControl_Label(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_Window->m_WindowHandle, controlId);
      if (!m_ControlHandle)
        kodi::Log(LOG_FATAL, "kodi::gui::CControlLabel can't create control class from Kodi !!!");
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlLabel.SetVisible(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, visible);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlLabel.SetLabel(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, text.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    std::string GetLabel() const
    {
      ...
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlLabel.GetLabel(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, text[0], size);
      text.resize(size);
      text.shrink_to_fit();
      return text;
    }
