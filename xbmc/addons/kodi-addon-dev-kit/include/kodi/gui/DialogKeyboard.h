...
namespace gui
{
  ...
  namespace DialogKeyboard
  {
      ...
      unsigned int            autoCloseMs = 0)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogKeyboard.ShowAndGetInputWithHead(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, text[0], size, heading.c_str(), allowEmptyResult, hiddenInput, autoCloseMs);
      text.resize(size);
      text.shrink_to_fit();
      return ret;
    }
      ...
      unsigned int            autoCloseMs = 0)
    {
      text.resize(1024);
      unsigned int size = (unsigned int)text.capacity();
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogKeyboard.ShowAndGetInput(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, text[0], size, allowEmptyResult, autoCloseMs);
      text.resize(size);
      text.shrink_to_fit();
      return ret;
    }
      ...
      unsigned int            autoCloseMs = 0)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogKeyboard.ShowAndGetNewPasswordWithHead(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, newPassword[0], size, heading.c_str(), allowEmptyResult, autoCloseMs);
      ...
      unsigned int            autoCloseMs = 0)
    {
      newPassword.resize(1024);
      unsigned int size = (unsigned int)newPassword.capacity();
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogKeyboard.ShowAndGetNewPassword(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, newPassword[0], size, autoCloseMs);
      newPassword.resize(size);
      newPassword.shrink_to_fit();
      return ret;
    }
      ...
      unsigned int            autoCloseMs = 0)
    {
      newPassword.resize(1024);
      unsigned int size = (unsigned int)newPassword.capacity();
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogKeyboard.ShowAndVerifyNewPassword(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, newPassword[0], size, autoCloseMs);
      newPassword.resize(size);
      newPassword.shrink_to_fit();
      return ret;
    }
      ...
      unsigned int            autoCloseMs = 0)
    {
      ...
      int ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogKeyboard.ShowAndVerifyPassword(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, password[0], size, heading.c_str(), retries, autoCloseMs);
      ...
      unsigned int            autoCloseMs = 0)
    {
      text.resize(1024);
      unsigned int size = (unsigned int)text.capacity();
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogKeyboard.ShowAndGetFilter(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, text[0], size, searching, autoCloseMs);
      text.resize(size);
      text.shrink_to_fit();
      return ret;
    }
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogKeyboard.SendTextToActiveKeyboard(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, text.c_str(), closeKeyboard);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogKeyboard.isKeyboardActivated(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance);
    }
    //--------------------------------------------------------------------------
  };
