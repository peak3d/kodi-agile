...
typedef struct sAddonToKodiFuncTable_kodi_gui_controlButton
{
  void (*SetVisible)(void* kodiInstance, void* handle, bool visible);
  void (*SetEnabled)(void* kodiInstance, void* handle, bool enabled);
  void (*SetLabel)(void* kodiInstance, void* handle, const char *label);
  void (*GetLabel)(void* kodiInstance, void* handle, char &label, unsigned int &iMaxStringSize);
  void (*SetLabel2)(void* kodiInstance, void* handle, const char *label);
  void (*GetLabel2)(void* kodiInstance, void* handle, char &label, unsigned int &iMaxStringSize);
} sAddonToKodiFuncTable_kodi_gui_controlButton;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlEdit
{
  void (*SetVisible)(void* kodiInstance, void* handle, bool visible);
  void (*SetEnabled)(void* kodiInstance, void* handle, bool enabled);
  void (*SetLabel)(void* kodiInstance, void* handle, const char *label);
  void (*GetLabel)(void* kodiInstance, void* handle, char &label, unsigned int &iMaxStringSize);
  void (*SetText)(void* kodiInstance, void* handle, const char *text);
  void (*GetText)(void* kodiInstance, void* handle, char &text, unsigned int &iMaxStringSize);
  void (*SetCursorPosition)(void* kodiInstance, void* handle, unsigned int iPosition);
  unsigned int (*GetCursorPosition)(void* kodiInstance, void* handle);
  void (*SetInputType)(void* kodiInstance, void* handle, int type, const char *heading);
} sAddonToKodiFuncTable_kodi_gui_controlEdit;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlFadeLabel
{
  void (*SetVisible)(void* kodiInstance, void* handle, bool visible);
  void (*AddLabel)(void* kodiInstance, void* handle, const char *text);
  void (*GetLabel)(void* kodiInstance, void* handle, char &text, unsigned int &iMaxStringSize);
  void (*SetScrolling)(void* kodiInstance, void* handle, bool scroll);
  void (*Reset)(void* kodiInstance, void* handle);
} sAddonToKodiFuncTable_kodi_gui_controlFadeLabel;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlImage
{
  void (*SetVisible)(void* kodiInstance, void* handle, bool visible);
  void (*SetFileName)(void* kodiInstance, void* handle, const char* strFileName, const bool useCache);
  void (*SetColorDiffuse)(void* kodiInstance, void* handle, uint32_t colorDiffuse);
} sAddonToKodiFuncTable_kodi_gui_controlImage;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlLabel
{
  void (*SetVisible)(void* kodiInstance, void* handle, bool visible);
  void (*SetLabel)(void* kodiInstance, void* handle, const char *text);
  void (*GetLabel)(void* kodiInstance, void* handle, char &text, unsigned int &iMaxStringSize);
} sAddonToKodiFuncTable_kodi_gui_controlLabel;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlProgress
{
  void (*SetVisible)(void* kodiInstance, void* handle, bool visible);
  void (*SetPercentage)(void* kodiInstance, void* handle, float fPercent);
  float (*GetPercentage)(void* kodiInstance, void* handle);
} sAddonToKodiFuncTable_kodi_gui_controlProgress;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlRadioButton
{
  void (*SetVisible)(void* kodiInstance, void* handle, bool yesNo);
  void (*SetEnabled)(void* kodiInstance, void* handle, bool enabled);
  void (*SetLabel)(void* kodiInstance, void* handle, const char *text);
  void (*GetLabel)(void* kodiInstance, void* handle, char &text, unsigned int &iMaxStringSize);
  void (*SetSelected)(void* kodiInstance, void* handle, bool yesNo);
  bool (*IsSelected)(void* kodiInstance, void* handle);
} sAddonToKodiFuncTable_kodi_gui_controlRadioButton;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlRendering
{
  void (*SetCallbacks)(void* kodiInstance, void* handle, void* clienthandle,
      bool    (*createCB)(void*,int,int,int,int,void*),
      void    (*renderCB)(void*),
      void    (*stopCB)(void*),
      bool    (*dirtyCB)(void*));
  void (*Delete)(void *kodiInstance, void* handle);
} sAddonToKodiFuncTable_kodi_gui_controlRendering;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlSettingsSlider
{
  void (*SetVisible)(void* kodiInstance, void* handle, bool yesNo);
  void (*SetEnabled)(void* kodiInstance, void* handle, bool yesNo);
  void (*SetText)(void* kodiInstance, void* handle, const char *label);
  void (*Reset)(void* kodiInstance, void* handle);
  void (*SetIntRange)(void* kodiInstance, void* handle, int iStart, int iEnd);
  void (*SetIntValue)(void* kodiInstance, void* handle, int iValue);
  int (*GetIntValue)(void* kodiInstance, void* handle);
  void (*SetIntInterval)(void* kodiInstance, void* handle, int iInterval);
  void (*SetPercentage)(void* kodiInstance, void* handle, float fPercent);
  float (*GetPercentage)(void* kodiInstance, void* handle);
  void (*SetFloatRange)(void* kodiInstance, void* handle, float fStart, float fEnd);
  void (*SetFloatValue)(void* kodiInstance, void* handle, float fValue);
  float (*GetFloatValue)(void* kodiInstance, void* handle);
  void (*SetFloatInterval)(void* kodiInstance, void* handle, float fInterval);
} sAddonToKodiFuncTable_kodi_gui_controlSettingsSlider;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlSlider
{
  void (*SetVisible)(void* kodiInstance, void* handle, bool yesNo);
  void (*SetEnabled)(void* kodiInstance, void* handle, bool yesNo);
  void (*Reset)(void* kodiInstance, void* handle);
  void (*GetDescription)(void* kodiInstance, void* handle, char &text, unsigned int &iMaxStringSize);
  void (*SetIntRange)(void* kodiInstance, void* handle, int start, int end);
  void (*SetIntValue)(void* kodiInstance, void* handle, int value);
  int (*GetIntValue)(void* kodiInstance, void* handle);
  void (*SetIntInterval)(void* kodiInstance, void* handle, int interval);
  void (*SetPercentage)(void* kodiInstance, void* handle, float percent);
  float (*GetPercentage)(void* kodiInstance, void* handle);
  void (*SetFloatRange)(void* kodiInstance, void* handle, float start, float end);
  void (*SetFloatValue)(void* kodiInstance, void* handle, float value);
  float (*GetFloatValue)(void* kodiInstance, void* handle);
  void (*SetFloatInterval)(void* kodiInstance, void* handle, float interval);
} sAddonToKodiFuncTable_kodi_gui_controlSlider;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlSpin
{
  void (*SetVisible)(void* kodiInstance, void* spinhandle, bool visible);
  void (*SetEnabled)(void* kodiInstance, void* spinhandle, bool enabled);
  void (*SetText)(void* kodiInstance, void* spinhandle, const char* text);
  void (*Reset)(void* kodiInstance, void* spinhandle);
  void (*SetType)(void* kodiInstance, void* handle, int type);
  void (*AddStringLabel)(void* kodiInstance, void* handle, const char* label, const char* value);
  void (*SetStringValue)(void* kodiInstance, void* handle, const char* value);
  void (*GetStringValue)(void* kodiInstance, void* handle, char& value, unsigned int& maxStringSize);
  void (*AddIntLabel)(void* kodiInstance, void* handle, const char* label, int value);
  void (*SetIntRange)(void* kodiInstance, void* handle, int start, int end);
  void (*SetIntValue)(void* kodiInstance, void* handle, int value);
  int (*GetIntValue)(void* kodiInstance, void* handle);
  void (*SetFloatRange)(void* kodiInstance, void* handle, float start, float end);
  ...
  float (*GetFloatValue)(void* kodiInstance, void* handle);
  void (*SetFloatInterval)(void* kodiInstance, void* handle, float interval);
} sAddonToKodiFuncTable_kodi_gui_controlSpin;

typedef struct sAddonToKodiFuncTable_kodi_gui_controlTextBox
{
  void (*SetVisible)(void* kodiInstance, void* spinhandle, bool visible);
  void (*Reset)(void* kodiInstance, void* handle);
  void (*SetText)(void* kodiInstance, void* handle, const char* text);
  void (*GetText)(void* kodiInstance, void* handle, char &text, unsigned int &iMaxStringSize);
  void (*Scroll)(void* kodiInstance, void* handle, unsigned int scroll);
  void (*SetAutoScrolling)(void* kodiInstance, void* handle, int delay, int time, int repeat);
} sAddonToKodiFuncTable_kodi_gui_controlTextBox;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogContextMenu
{
  int (*Open)(void* kodiInstance, const char *heading, const char *entries[], unsigned int size);
} sAddonToKodiFuncTable_kodi_gui_dialogContextMenu;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogExtendedProgress
{
  void* (*New)(void* kodiInstance, const char *title);
  void (*Delete)(void* kodiInstance, void* handle);
  void (*Title)(void* kodiInstance, void* handle, char &title, unsigned int &iMaxStringSize);
  void (*SetTitle)(void* kodiInstance, void* handle, const char *title);
  void (*Text)(void* kodiInstance, void* handle, char &text, unsigned int &iMaxStringSize);
  void (*SetText)(void* kodiInstance, void* handle, const char *text);
  bool (*IsFinished)(void* kodiInstance, void* handle);
  void (*MarkFinished)(void* kodiInstance, void* handle);
  float (*Percentage)(void* kodiInstance, void* handle);
  void (*SetPercentage)(void* kodiInstance, void* handle, float fPercentage);
  void (*SetProgress)(void* kodiInstance, void* handle, int currentItem, int itemCount);
} sAddonToKodiFuncTable_kodi_gui_dialogExtendedProgress;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogFileBrowser
{
  bool (*ShowAndGetDirectory)(void* kodiInstance, const char* shares, const char* heading, char& path, unsigned int& iMaxStringSize, bool bWriteOnly);
  bool (*ShowAndGetFile)(void* kodiInstance, const char* shares, const char* mask, const char* heading, char& file, unsigned int& iMaxStringSize, bool useThumbs, bool useFileDirectories);
  bool (*ShowAndGetFileFromDir)(void* kodiInstance, const char* directory, const char* mask, const char* heading, char& file, unsigned int& iMaxStringSize, bool useThumbs, bool useFileDirectories, bool singleList);
  bool (*ShowAndGetFileList)(void* kodiInstance, const char* shares, const char* mask, const char* heading, char**& path, unsigned int& entries, bool useThumbs, bool useFileDirectories);
  bool (*ShowAndGetSource)(void* kodiInstance, char& path, unsigned int& iMaxStringSize, bool allowNetworkShares, const char* additionalShare, const char* strType);
  bool (*ShowAndGetImage)(void* kodiInstance, const char* shares, const char* heading, char& path, unsigned int& iMaxStringSize);
  bool (*ShowAndGetImageList)(void* kodiInstance,  const char* shares, const char* heading, char**& path, unsigned int& entries);
  void (*ClearList)(void* kodiInstance, char**& path, unsigned int entries);
} sAddonToKodiFuncTable_kodi_gui_dialogFileBrowser;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogKeyboard
{
  bool (*ShowAndGetInputWithHead)(void* kodiInstance, char &strTextString, unsigned int &iMaxStringSize, const char *heading, bool allowEmptyResult, bool hiddenInput, unsigned int autoCloseMs);
  bool (*ShowAndGetInput)(void* kodiInstance, char &strTextString, unsigned int &iMaxStringSize, bool allowEmptyResult, unsigned int autoCloseMs);
  bool (*ShowAndGetNewPasswordWithHead)(void* kodiInstance, char &newPassword, unsigned int &iMaxStringSize, const char *strHeading, bool allowEmptyResult, unsigned int autoCloseMs);
  bool (*ShowAndGetNewPassword)(void* kodiInstance, char &strNewPassword, unsigned int &iMaxStringSize, unsigned int autoCloseMs);
  bool (*ShowAndVerifyNewPasswordWithHead)(void* kodiInstance, char &strNewPassword, unsigned int &iMaxStringSize, const char *strHeading, bool allowEmpty, unsigned int autoCloseMs);
  bool (*ShowAndVerifyNewPassword)(void* kodiInstance, char &strNewPassword, unsigned int &iMaxStringSize, unsigned int autoCloseMs);
  int (*ShowAndVerifyPassword)(void* kodiInstance, char &strPassword, unsigned int &iMaxStringSize, const char *strHeading, int iRetries, unsigned int autoCloseMs);
  bool (*ShowAndGetFilter)(void* kodiInstance, char &aTextString, unsigned int &iMaxStringSize, bool searching, unsigned int autoCloseMs);
  bool (*SendTextToActiveKeyboard)(void* kodiInstance, const char *aTextString, bool closeKeyboard);
  bool (*isKeyboardActivated)(void* kodiInstance);
} sAddonToKodiFuncTable_kodi_gui_dialogKeyboard;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogNumeric
{
  bool (*ShowAndVerifyNewPassword)(void* kodiInstance, char &strNewPassword, unsigned int &iMaxStringSize);
  int (*ShowAndVerifyPassword)(void* kodiInstance, char &strPassword, unsigned int &iMaxStringSize, const char *strHeading, int iRetries);
  bool (*ShowAndVerifyInput)(void* kodiInstance, char &strPassword, unsigned int &iMaxStringSize, const char *strHeading, bool bVerifyInput);
  bool (*ShowAndGetTime)(void* kodiInstance, tm &time, const char *strHeading);
  bool (*ShowAndGetDate)(void* kodiInstance, tm &date, const char *strHeading);
  bool (*ShowAndGetIPAddress)(void* kodiInstance, char &strIPAddress, unsigned int &iMaxStringSize, const char *strHeading);
  bool (*ShowAndGetNumber)(void* kodiInstance, char &strInput, unsigned int &iMaxStringSize, const char *strHeading, unsigned int iAutoCloseTimeoutMs);
  bool (*ShowAndGetSeconds)(void* kodiInstance, char &timeString, unsigned int &iMaxStringSize, const char *strHeading);
} sAddonToKodiFuncTable_kodi_gui_dialogNumeric;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogOK
{
  void (*ShowAndGetInputSingleText)(void* kodiInstance, const char *heading, const char *text);
  void (*ShowAndGetInputLineText)(void* kodiInstance, const char *heading, const char *line0, const char *line1, const char *line2);
} sAddonToKodiFuncTable_kodi_gui_dialogOK;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogProgress
{
  void* (*New)(void* kodiInstance);
  void (*Delete)(void* kodiInstance, void* handle);
  void (*Open)(void* kodiInstance, void* handle);
  void (*SetHeading)(void* kodiInstance, void* handle, const char* heading);
  void (*SetLine)(void* kodiInstance, void* handle, unsigned int iLine, const char* line);
  void (*SetCanCancel)(void* kodiInstance, void* handle, bool bCanCancel);
  bool (*IsCanceled)(void* kodiInstance, void* handle);
  void (*SetPercentage)(void* kodiInstance, void* handle, int iPercentage);
  int (*GetPercentage)(void* kodiInstance, void* handle);
  void (*ShowProgressBar)(void* kodiInstance, void* handle, bool bOnOff);
  void (*SetProgressMax)(void* kodiInstance, void* handle, int iMax);
  void (*SetProgressAdvance)(void* kodiInstance, void* handle, int nSteps);
  bool (*Abort)(void* kodiInstance, void* handle);
} sAddonToKodiFuncTable_kodi_gui_dialogProgress;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogSelect
{
  int (*Open)(void* kodiInstance, const char *heading, const char *entries[], unsigned int size, int selected, bool autoclose);
} sAddonToKodiFuncTable_kodi_gui_dialogSelect;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogTextViewer
{
  void (*Open)(void* kodiInstance, const char *heading, const char *text);
} sAddonToKodiFuncTable_kodi_gui_dialogTextViewer;

typedef struct sAddonToKodiFuncTable_kodi_gui_dialogYesNo
{
  bool (*ShowAndGetInputSingleText)(void* kodiInstance, const char *heading, const char *text, bool &bCanceled, const char *noLabel, const char *yesLabel);
  bool (*ShowAndGetInputLineText)(void* kodiInstance, const char *heading, const char *line0, const char *line1, const char *line2, const char *noLabel, const char *yesLabel);
  bool (*ShowAndGetInputLineButtonText)(void* kodiInstance, const char *heading, const char *line0, const char *line1, const char *line2, bool &bCanceled, const char *noLabel, const char *yesLabel);
} sAddonToKodiFuncTable_kodi_gui_dialogYesNo;

typedef struct sAddonToKodiFuncTable_kodi_gui_listItem
{
  void* (*Create)(void* kodiInstance, const char* label, const char* label2, const char* iconImage, const char* thumbnailImage, const char* path);
  void (*Destroy)(void* kodiInstance, void* handle);
  void (*GetLabel)(void* kodiInstance, void* handle, char& label, unsigned int &iMaxStringSize);
  void (*SetLabel)(void* kodiInstance, void* handle, const char* label);
  void (*GetLabel2)(void* kodiInstance, void* handle, char& label, unsigned int& iMaxStringSize);
  void (*SetLabel2)(void* kodiInstance, void* handle, const char* label);
  void (*GetIconImage)(void* kodiInstance, void* handle, char& image, unsigned int &iMaxStringSize);
  void (*SetIconImage)(void* kodiInstance, void* handle, const char* image);
  ...
  void (*SetArt)(void* kodiInstance, void* handle, const char* type, const char* url);
  char* (*GetArt)(void* kodiInstance, void* handle, const char* type);
  void (*SetArtFallback)(void* kodiInstance, void* handle, const char* from, const char* to);
  bool (*HasArt)(void* kodiInstance, void* handle, const char *type);
  void (*Select)(void* kodiInstance, void* handle, bool bOnOff);
  bool (*IsSelected)(void* kodiInstance, void* handle);
  bool (*HasIcon)(void* kodiInstance, void* handle);
  bool (*HasOverlay)(void* kodiInstance, void* handle);
  bool (*IsFileItem)(void* kodiInstance, void* handle);
  bool (*IsFolder)(void* kodiInstance, void* handle);
  void (*SetProperty)(void* kodiInstance, void* handle, const char *key, const char *value);
  void (*GetProperty)(void* kodiInstance, void* handle, const char* key, char& property, unsigned int &iMaxStringSize);
  void (*ClearProperty)(void* kodiInstance, void* handle, const char* key);
  void (*ClearProperties)(void* kodiInstance, void* handle);
  bool (*HasProperties)(void* kodiInstance, void* handle);
  bool (*HasProperty)(void* kodiInstance, void* handle, const char* key);
  void (*SetPath)(void* kodiInstance, void* handle, const char* path);
  char* (*GetPath)(void* kodiInstance, void* handle);
  char* (*GetDescription)(void* kodiInstance, void* handle);
  int (*GetDuration)(void* kodiInstance, void* handle);
  void (*SetSubtitles)(void* kodiInstance, void* handle, const char** streams, unsigned int entries);
  void (*SetMimeType)(void* kodiInstance, void* handle, const char* mimetype);
  void (*SetContentLookup)(void* kodiInstance, void* handle, bool enable);
  void (*AddContextMenuItems)(void* kodiInstance, void* handle, const char** streams[2], unsigned int entries, bool replaceItems);
  void (*AddStreamInfo)(void* kodiInstance, void* handle, const char* cType, const char** dictionary[2], unsigned int entries);
  void (*SetMusicInfo)(void* kodiInstance, void* handle, unsigned int  type, void* data, unsigned int entries);
  void (*SetVideoInfo)(void* kodiInstance, void* handle, unsigned int type, void* data, unsigned int entries);
  void (*SetPictureInfo)(void* kodiInstance, void* handle, unsigned int type, void* data, unsigned int entries);
} sAddonToKodiFuncTable_kodi_gui_listItem;

typedef struct sAddonToKodiFuncTable_kodi_gui_general
{
  void (*Lock)();
  void (*Unlock)();
  int (*GetScreenHeight)(void* kodiInstance);
  int (*GetScreenWidth)(void* kodiInstance);
  int (*GetVideoResolution)(void* kodiInstance);
  int (*GetCurrentWindowDialogId)(void* kodiInstance);
  int (*GetCurrentWindowId)(void* kodiInstance);
} sAddonToKodiFuncTable_kodi_gui_general;

typedef struct sAddonToKodiFuncTable_kodi_gui_window
{
  void* (*New)(void* kodiInstance, const char* xmlFilename, const char* defaultSkin, bool forceFallback, bool asDialog);
  void (*Delete)(void* kodiInstance, void* handle);
  void (*SetCallbacks)(void* kodiInstance, void* handle, void* clienthandle,
       bool (*)(void* handle),
       ...
       bool (*)(void* handle, int),
       bool (*)(void* handle, int));
  bool (*Show)(void* kodiInstance, void* handle);
  bool (*Close)(void* kodiInstance, void* handle);
  bool (*DoModal)(void* kodiInstance, void* handle);
  bool (*SetFocusId)(void* kodiInstance, void* handle, int iControlId);
  int (*GetFocusId)(void* kodiInstance, void* handle);
  void (*SetProperty)(void* kodiInstance, void* handle, const char* key, const char* value);
  void (*SetPropertyInt)(void* kodiInstance, void* handle, const char* key, int value);
  void (*SetPropertyBool)(void* kodiInstance, void* handle, const char* key, bool value);
  void (*SetPropertyDouble)(void* kodiInstance, void* handle, const char* key, double value);
  void (*GetProperty)(void* kodiInstance, void* handle, const char *key, char &property, unsigned int &iMaxStringSize);
  int (*GetPropertyInt)(void* kodiInstance, void* handle, const char  *key);
  bool (*GetPropertyBool)(void* kodiInstance, void* handle, const char *key);
  double (*GetPropertyDouble)(void* kodiInstance, void* handle, const char* key);
  void (*ClearProperties)(void* kodiInstance, void* handle);
  void (*ClearProperty)(void* kodiInstance, void* handle, const char  *key);
  int (*GetListSize)(void* kodiInstance, void* handle);
  void (*ClearList)(void* kodiInstance, void* handle);
  void* (*AddItem)(void* kodiInstance, void* handle, void* item, int itemPosition);
  void* (*AddStringItem)(void* kodiInstance, void* handle, const char  *itemName, int itemPosition);
  void (*RemoveItem)(void* kodiInstance, void* handle, int itemPosition);
  void (*RemoveItemFile)(void* kodiInstance, void* handle, void* fileItem);
  void* (*GetListItem)(void* kodiInstance, void* handle, int listPos);
  void (*SetCurrentListPosition)(void* kodiInstance, void* handle, int listPos);
  int (*GetCurrentListPosition)(void* kodiInstance, void* handle);
  void (*SetControlLabel)(void* kodiInstance, void* handle, int controlId, const char* label);
  void (*MarkDirtyRegion)(void* kodiInstance, void* handle);

  void* (*GetControl_Button)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_Edit)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_FadeLabel)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_Image)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_Label)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_Spin)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_RadioButton)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_Progress)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_RenderAddon)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_Slider)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_SettingsSlider)(void* kodiInstance, void* handle, int controlId);
  void* (*GetControl_TextBox)(void* kodiInstance, void* handle, int controlId);
} sAddonToKodiFuncTable_kodi_gui_window;

typedef struct sAddonToKodiFuncTable_kodi_gui
{
  sAddonToKodiFuncTable_kodi_gui_general general;
  sAddonToKodiFuncTable_kodi_gui_controlButton controlButton;
  sAddonToKodiFuncTable_kodi_gui_controlEdit controlEdit;
  sAddonToKodiFuncTable_kodi_gui_controlFadeLabel controlFadeLabel;
  sAddonToKodiFuncTable_kodi_gui_controlImage controlImage;
  sAddonToKodiFuncTable_kodi_gui_controlLabel controlLabel;
  sAddonToKodiFuncTable_kodi_gui_controlProgress controlProgress;
  sAddonToKodiFuncTable_kodi_gui_controlRadioButton controlRadioButton;
  sAddonToKodiFuncTable_kodi_gui_controlRendering controlRendering;
  sAddonToKodiFuncTable_kodi_gui_controlSettingsSlider controlSettingsSlider;
  sAddonToKodiFuncTable_kodi_gui_controlSlider controlSlider;
  sAddonToKodiFuncTable_kodi_gui_controlSpin controlSpin;
  sAddonToKodiFuncTable_kodi_gui_controlTextBox controlTextBox;
  sAddonToKodiFuncTable_kodi_gui_dialogContextMenu dialogContextMenu;
  sAddonToKodiFuncTable_kodi_gui_dialogExtendedProgress dialogExtendedProgress;
  sAddonToKodiFuncTable_kodi_gui_dialogFileBrowser dialogFileBrowser;
  sAddonToKodiFuncTable_kodi_gui_dialogKeyboard dialogKeyboard;
  sAddonToKodiFuncTable_kodi_gui_dialogNumeric dialogNumeric;
  sAddonToKodiFuncTable_kodi_gui_dialogOK dialogOK;
  sAddonToKodiFuncTable_kodi_gui_dialogProgress dialogProgress;
  sAddonToKodiFuncTable_kodi_gui_dialogSelect dialogSelect;
  sAddonToKodiFuncTable_kodi_gui_dialogTextViewer dialogTextViewer;
  sAddonToKodiFuncTable_kodi_gui_dialogYesNo dialogYesNo;
  sAddonToKodiFuncTable_kodi_gui_listItem listItem;
  sAddonToKodiFuncTable_kodi_gui_window window;
} sAddonToKodiFuncTable_kodi_gui;
...
//============================================================================
///
/// \ingroup cpp_kodi_gui_CWindow_Defs
/// @{
