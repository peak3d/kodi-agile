...
namespace gui
{
  ...
  namespace DialogOK
  {
    ...
    /// ~~~~~~~~~~~~~
    ///
    inline void ShowAndGetInput(
      const std::string&      heading,
      const std::string&      text)
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogOK.ShowAndGetInputSingleText(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, heading.c_str(), text.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogOK.ShowAndGetInputLineText(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, heading.c_str(), line0.c_str(), line1.c_str(), line2.c_str());
    }
    //--------------------------------------------------------------------------
  }
  /// @}
