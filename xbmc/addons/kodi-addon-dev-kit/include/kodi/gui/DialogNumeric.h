...
namespace gui
{
  ...
  namespace DialogNumeric
  {
    ...
    inline bool ShowAndVerifyNewPassword(std::string& newPassword)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogNumeric.ShowAndVerifyNewPassword(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, newPassword[0], size);
      ...
      int                     iRetries)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogNumeric.ShowAndVerifyPassword(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, password[0], size, heading.c_str(), iRetries);
      ...
      bool                    verifyInput)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogNumeric.ShowAndVerifyInput(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, toVerify[0], size, heading.c_str(), verifyInput);
    ...
    inline bool ShowAndGetTime(
      ...
      const std::string&      heading)
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogNumeric.ShowAndGetTime(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, time, heading.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    inline bool ShowAndGetDate(
      ...
      const std::string&      heading)
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogNumeric.ShowAndGetDate(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, date, heading.c_str());
    }
    //--------------------------------------------------------------------------
      ...
      const std::string&      heading)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogNumeric.ShowAndGetIPAddress(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, ipAddress[0], size, heading.c_str());
      ...
      unsigned int            autoCloseTimeoutMs = 0)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogNumeric.ShowAndGetNumber(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, input[0], size, heading.c_str(), autoCloseTimeoutMs);
      input.resize(size);
      input.shrink_to_fit();
      return ret;
    }
      ...
      const std::string&      heading)
    {
      ...
      bool ret = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogNumeric.ShowAndGetSeconds(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, time[0], size, heading.c_str());
      time.resize(size);
      time.shrink_to_fit();
      return ret;
    }
