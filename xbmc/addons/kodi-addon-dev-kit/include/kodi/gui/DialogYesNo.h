...
namespace gui
{
  ...
  namespace DialogYesNo
  {
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogYesNo.ShowAndGetInputSingleText(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, heading.c_str(), text.c_str(), canceled, noLabel.c_str(), yesLabel.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    inline bool ShowAndGetInput(
      ...
      const std::string&      yesLabel = "")
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogYesNo.ShowAndGetInputLineText(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, heading.c_str(), line0.c_str(), line1.c_str(), line2.c_str(), noLabel.c_str(), yesLabel.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    inline bool ShowAndGetInput(
      ...
      const std::string&      yesLabel = "")
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->dialogYesNo.ShowAndGetInputLineButtonText(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, heading.c_str(), line0.c_str(), line1.c_str(), line2.c_str(), canceled, noLabel.c_str(), yesLabel.c_str());
    }
    //--------------------------------------------------------------------------
  };
  /// @}
