...
namespace gui
{
  ...
  public:
    ...
    {
      m_ControlHandle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetControl_FadeLabel(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_Window->m_WindowHandle, controlId);
      if (!m_ControlHandle)
        kodi::Log(LOG_FATAL, "kodi::gui::CControlFadeLabel can't create control class from Kodi !!!");
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlFadeLabel.SetVisible(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, visible);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlFadeLabel.AddLabel(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, label.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    std::string GetLabel() const
    {
      ...
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlFadeLabel.GetLabel(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, text[0], size);
      text.resize(size);
      text.shrink_to_fit();
      return text;
    }
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlFadeLabel.SetScrolling(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, scroll);
    }
    //--------------------------------------------------------------------------
    ...
    void Reset()
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlFadeLabel.Reset(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle);
    }
    //--------------------------------------------------------------------------
