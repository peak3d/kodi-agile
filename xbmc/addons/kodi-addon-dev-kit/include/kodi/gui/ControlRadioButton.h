...
namespace gui
{
  ...
  public:
    ...
    {
      m_ControlHandle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetControl_RadioButton(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_Window->m_WindowHandle, controlId);
      if (!m_ControlHandle)
        kodi::Log(LOG_FATAL, "kodi::gui::CControlRadioButton can't create control class from Kodi !!!");
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlRadioButton.SetVisible(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, visible);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlRadioButton.SetEnabled(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, enabled);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlRadioButton.SetLabel(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, label.c_str());
    }
    //--------------------------------------------------------------------------
    ...
    std::string GetLabel() const
    {
      ...
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlRadioButton.GetLabel(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, text[0], size);
      text.resize(size);
      text.shrink_to_fit();
      return text;
    }
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlRadioButton.SetSelected(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, selected);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlRadioButton.IsSelected(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle);
    }
    //--------------------------------------------------------------------------
