...
namespace gui
{
  ...
  public:
    ...
    {
      m_ControlHandle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetControl_RenderAddon(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_Window->m_WindowHandle, controlId);
      if (m_ControlHandle)
        ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlRendering.SetCallbacks(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, this,
                                              OnCreateCB, OnRenderCB, OnStopCB, OnDirtyCB);
      else
        kodi::Log(LOG_FATAL, "kodi::gui::CControlRendering can't create control class from Kodi !!!");
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlRendering.Delete(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle);
    }
    //--------------------------------------------------------------------------
        ...
        bool      (*CBDirty) (GUIHANDLE cbhdl))
    {
      ...
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlRendering.SetCallbacks(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, cbhdl,
                                          CBCreate, CBRender, CBStop, CBDirty);
    }
    //--------------------------------------------------------------------------
