...
namespace gui
{
  ...
  public:
    ...
    {
      m_ControlHandle = ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->window.GetControl_Slider(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_Window->m_WindowHandle, controlId);
      if (!m_ControlHandle)
        kodi::Log(LOG_FATAL, "kodi::gui::CControlSlider can't create control class from Kodi !!!");
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.SetVisible(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, visible);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.SetEnabled(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, enabled);
    }
    //--------------------------------------------------------------------------
    ...
    void Reset()
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.Reset(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle);
    }
    //--------------------------------------------------------------------------
    ...
    std::string GetDescription() const
    {
      ...
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.GetDescription(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, text[0], size);
      text.resize(size);
      text.shrink_to_fit();
      return text;
    }
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.SetIntRange(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, start, end);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.SetIntValue(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, value);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.GetIntValue(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.SetIntInterval(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, interval);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.SetPercentage(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, percent);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.GetPercentage(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.SetFloatRange(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, start, end);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.SetFloatValue(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, value);
    }
    //--------------------------------------------------------------------------
    ...
    {
      return ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.GetFloatValue(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle);
    }
    //--------------------------------------------------------------------------
    ...
    {
      ::kodi::addon::CAddonBase::m_instance->toKodi.kodi_gui->controlSlider.SetFloatInterval(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_ControlHandle, interval);
    }
    //--------------------------------------------------------------------------
