 ...
 * -------------------------
 * 
 * Addon header file to bring soundplay interface functions to call inside Kodi.
 */
...
namespace kodi
{
  //==========================================================================
  ///
  /// \defgroup CPP_kodi_SoundPlay Sound Playback (class CSoundPlay)
  /// \ingroup CPP_kodi
  /// @{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_kodi_SoundPlay_Defs Definitions, structures and enumerators
  ...
  public:
    ...
    ///
    void SetChannel(eAudioChannel channel)
    {
      if (m_playHandle)
    ...
    ///
    eAudioChannel GetChannel()
    {
      if (!m_playHandle)
        return AUDIO_CH_NULL;
      return (eAudioChannel)::kodi::addon::CAddonBase::m_instance->toKodi.kodi_audio->soundplay_get_channel(::kodi::addon::CAddonBase::m_instance->toKodi.kodiInstance, m_playHandle);
    }
    //--------------------------------------------------------------------------
