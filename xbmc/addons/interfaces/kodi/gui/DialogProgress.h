...
extern "C"
{
  ...
  struct Interface_GUIDialogProgress
  {
    ...
    static void SetCanCancel(void *addonData, void* handle, bool canCancel);
    static bool IsCanceled(void *addonData, void* handle);
    static void SetPercentage(void *addonData, void* handle, int percentage);
    static int GetPercentage(void *addonData, void* handle);
    static void ShowProgressBar(void *addonData, void* handle, bool bOnOff);
    static void SetProgressMax(void *addonData, void* handle, int max);
